...
def baseline_train(runid,
    ...
    for epoch in range(begin_epoch, begin_epoch + epochs + 1):
        ...
        for iter, (x, pos) in train_tqdm_loader:
            ...
            record(train_rec_mae, train_rec_rmse, train_rec_mape, rec_set[0], rec_set[1], rec_set[2], mode="NYC")
            record(train_pred_mae, train_pred_rmse, train_pred_mape, pred_set[0], pred_set[1], pred_set[2], mode="NYC")
            record(train_hispred_mae, train_hispred_rmse, train_hispred_mape, hispred_set[0], hispred_set[1], hispred_set[2], mode="NYC")
