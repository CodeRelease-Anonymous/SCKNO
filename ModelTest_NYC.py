...
def model_val(runid, engine, dataloader, device, logger, cfg, epoch, loss_list, data_dim_list):
    ...
    for iter, (x, pos) in val_tqdm_loader:
        ...
        record(valid_rec_mae, valid_rec_rmse, valid_rec_mape, rec_set[0], rec_set[1], rec_set[2], mode="NYC")
        record(valid_pred_mae, valid_pred_rmse, valid_pred_mape, pred_set[0], pred_set[1], pred_set[2], mode="NYC")
        record(valid_hispred_mae, valid_hispred_rmse, valid_hispred_mape, hispred_set[0], hispred_set[1],
               hispred_set[2], mode="NYC")
...
def model_test(runid, engine, dataloader, device, logger, cfg, loss_list, data_dim_list, mode='Test', ):
    ...
    for iter, (x, pos) in test_tqdm_loader:
        ...
        record(test_rec_mae, test_rec_rmse, test_rec_mape, rec_set[0], rec_set[1], rec_set[2], mode="NYC")
        record(test_pred_mae, test_pred_rmse, test_pred_mape, pred_set[0], pred_set[1], pred_set[2], mode="NYC")
